...
<h3><span class="glyphicon glyphicon-briefcase"></span>  Data Regional Manager</h3>
<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>Tambah ROM</button>
<br/>
<br/>
...
<form action="cari_act_rom.php" method="get">
...
<table class="table table-hover">
	<?php
		if($_SESSION['region']==NULL && $_SESSION['success'] ==NULL && $_SESSION['error']==NULL){
	?>
	...
	<?php }else if($_SESSION['region'] !=NULL){ ?>
	...
	if(isset($_GET['cari'])){
		...
		$brg=mysql_query("SELECT DISTINCT
						...
						WHERE
							...
							OR ITH_USER.nama_jabatan LIKE '%$cari%'
	...
	while($b=mysql_fetch_array($brg)){
		...
		<tr>
			...
			<td>
				<a href="mutasi_rom.php?user_nik=<?php echo $b['user_nik']; ?>"><span class="glyphicon glyphicon-file" title="Mutasi"></a>
				<a href="promosi_rom.php?user_nik=<?php echo $b['user_nik']; ?>"><span class="glyphicon glyphicon-check" title="Promosi"></a>
				<a href="demosi_rom.php?user_nik=<?php echo $b['user_nik']; ?>"><span class="glyphicon glyphicon-copy" title="Demosi"></a>
				<a href="edit_rom.php?user_nik=<?php echo $b['user_nik']; ?>"><span class="glyphicon glyphicon-edit" title="Edit"></a>
...
<ul class="pagination">		
	...
	<?php
        ...
        ?>
          <li <?php echo $link_active; ?>><a href="rom.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
        <?php
        }
        ?>
        ...
        ?>
          <li><a href="rom.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
          <li><a href="rom.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
        <?php
        }
    ?>
</ul>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="tmb_rom_act.php" method="post">
					<div class="form-group">
						<label>NIK</label>
						<input name="nik" type="text" class="form-control" placeholder="NIK .." Required>
					</div>
					<div class="form-group">
						<label>Nama Regional Manager</label>
						<input name="namaROM" type="text" class="form-control" placeholder="Nama Regional Manager .." Required>
					</div>
					<div class="form-group">
						<label>Email Regional Manager</label>
						<input name="emailROM" type="text" class="form-control" placeholder="Email Regional Manager .." Required>
					</div>
					<div class="form-group">
						<label>RSC Regional Manager</label>								
					...
					<div class="form-group">
						<script type="text/javascript" src="jquery-1.4.2.min.js"></script>
							...
							<select name="region" id="region" class="form-control">
								<option value="">- Pilih Region ROM -</option>
								...
								?>
									<option value="<?php echo $data_prov["usergroup_kd"] ?>"><?php echo $data_prov["usergroup_aliasname"] ?> (<?php echo $output;?>)</option>
								<?php
									}
								?>
							</select>
					...
					<div class="form-group">
						<label>Regional Manager Deputi..?</label><br>
