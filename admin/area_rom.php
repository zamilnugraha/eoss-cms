...
<?php
    ...
    ?>
        <option <?php if($dataArea['usergroup_kd']==$dataArea['usergroup_kd']) { echo "selected"; } ?> value="<?php echo $dataArea["usersubgroup_kd"] ?>"><?php echo $dataArea["usersubgroup_name"] ?>  (<?php echo $output;?>)</option><br>
    <?php
    }
?>